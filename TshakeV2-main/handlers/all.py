...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/Source_e")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/ssfe2")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/WAT_JJ")]])
